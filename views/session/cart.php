...
<div class="w-full flex justify-center my-6">
    <div class="flex flex-col w-full text-gray-800 bg-white shadow-lg pin-r pin-y md:w-4/5 lg:w-4/5">
        <? if (!$cart->isEmpty() && $cart->isConform()): ?>
                ...
                <div class="my-4 mt-6 -mx-2 lg:flex">
                    ...
                    <div class="lg:px-4 lg:w-1/2">
                        ...
                        <div class="p-4">
                            ...
                            <!-- Button checkout -->
                            <button id="checkout" class="flex justify-center w-full px-10 py-2 mt-6 font-medium text-white uppercase bg-gray-800 rounded-full shadow item-center hover:bg-gray-700 focus:shadow-outline focus:outline-none">
        ...
        <? elseif (!$cart->isConform()): ?>

            <div class="w-full text-center rounded-lg py-16" style="background-image: linear-gradient(to right bottom, #792d2d, #5c2d2d, #914223, #8f3333, #8d3d3d);">
                <div class="flex flex-col text-center justify-center items-center">
                    <? $ASSET::image('error') ?>
                    <p class="font-bold text-3xl text-gray-100 leading-tight uppercase my-8 py-8 pb-5">
                        Your cart has an error
                    </p>
                    <a href="/cart/reset">
