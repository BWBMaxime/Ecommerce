<? if ($search): ?>
    ...
    <? if ($current_page > 2): ?>
    <a href="/products/1?search=<?= $_GET['search'] ?>"  title="Go to first page">
    ...
    <? if ($current_page > 1): ?>
    <a href="/products/<?= $current_page - 1 ?>?search=<?= $_GET['search'] ?>" title="Go to previous page">
    ...
    <a href="/products/<?= $current_page + 1 ?>?search=<?= $_GET['search'] ?>" title="Go to next page">
    ...
    <a href="/products/<?= $last_page ?>?search=<?= $_GET['search'] ?>" title="Go to last page">
